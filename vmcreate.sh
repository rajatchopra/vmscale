...
cd libvirt_storage
export STORAGE_PATH=/data/src/vmscale/libvirt_storage
...
virsh pool-define-as --type dir --name ovn-kubernetes --target /data/src/vmscale
...
do
  ...
  virsh vol-create-as ovn-kubernetes ${NODE_NAME}.qcow2 20G --format qcow2 --backing-vol /data/src/vmscale/CentOS-7-x86_64-GenericCloud.qcow2 --backing-vol-format qcow2
